...
export default function PreferencesPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      <PanelHeader title={t('preferencesSettings.title')} actions={<HeaderMenu route={routes.view.settings('preferences')} helpFeature="preferences" />} />
      <div className="flex-1 min-h-0 mask-fade-y">
        <ScrollArea className="h-full">
          <div className="px-5 py-7 max-w-3xl mx-auto space-y-8">
          {/* Basic Info */}
          <SettingsSection
            title={t('preferencesSettings.basicInfo')}
            description={t('preferencesSettings.basicInfoDesc')}
          >
            <SettingsCard divided>
              <SettingsInput
                label={t('preferencesSettings.name')}
                description={t('preferencesSettings.nameDesc')}
                value={formState.name}
                onChange={(v) => updateField('name', v)}
                placeholder={t('preferencesSettings.namePlaceholder')}
                inCard
              />
              <SettingsInput
                label={t('preferencesSettings.timezone')}
                description={t('preferencesSettings.timezoneDesc')}
                value={formState.timezone}
                onChange={(v) => updateField('timezone', v)}
                placeholder={t('preferencesSettings.timezonePlaceholder')}
                inCard
              />
              <SettingsInput
                label={t('preferencesSettings.preferredLanguage')}
                description={t('preferencesSettings.preferredLanguageDesc')}
                value={formState.language}
                onChange={(v) => updateField('language', v)}
                placeholder={t('preferencesSettings.preferredLanguagePlaceholder')}
                inCard
              />
            </SettingsCard>
          </SettingsSection>
          ...
          {/* Location */}
          <SettingsSection
            title={t('preferencesSettings.location')}
            description={t('preferencesSettings.locationDesc')}
          >
            <SettingsCard divided>
              <SettingsInput
                label={t('preferencesSettings.city')}
                description={t('preferencesSettings.cityDesc')}
                value={formState.city}
                onChange={(v) => updateField('city', v)}
                placeholder={t('preferencesSettings.cityPlaceholder')}
                inCard
              />
              <SettingsInput
                label={t('preferencesSettings.country')}
                description={t('preferencesSettings.countryDesc')}
                value={formState.country}
                onChange={(v) => updateField('country', v)}
                placeholder={t('preferencesSettings.countryPlaceholder')}
                inCard
              />
            </SettingsCard>
          </SettingsSection>
          ...
          {/* Notes */}
          <SettingsSection
            title={t('preferencesSettings.notes')}
            description={t('preferencesSettings.notesDesc')}
            action={
          ...
          >
            <SettingsCard divided={false}>
              <SettingsTextarea
                ...
                placeholder={t('preferencesSettings.notesPlaceholder')}
                rows={5}
                inCard
              />
            </SettingsCard>
